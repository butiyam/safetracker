        ...
        <div className="footer">
            <Container gap={1.5} md>
                ...
                <Grid.Container className="py-5" justify="space-between" alignItems="center">
                    <Grid>
                        <Text size={24} css={{ lh: 1.3 }}>
                            <span className="highlight">Safe</span>Tracker
                        </Text>
                    ...
                    <Grid>
                        <Grid.Container justify="end" alignItems="center">
                            <Grid css={{ mr: 20 }}>
                                <Link href="https://t.me/butiyam"  rel="nofollow noopener" aria-label="Twitter">
                                    <Button auto light css={{ px: 0 }}>
                                        <BrandIcon icon="telegram" size={36}/>
                                    </Button>
                                </Link>
                            </Grid>
                            <Grid css={{ mr: 20 }}>
                                <Link href="#"  rel="nofollow noopener" aria-label="Discord">
                                    <Button auto light css={{ px: 0 }}>
                ...
                <Grid.Container className="py-5">
                    <Grid xs>
                        <Text size={14}>
                            &copy; 2022 SafeTracker | All Rights Reserved
                        </Text>
                    </Grid>
                </Grid.Container>
            </Container>
