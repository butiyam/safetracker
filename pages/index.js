                    ...
                    <Card.Body>
                        <Grid.Container justify="space-between" alignItems="center">
                            <Grid>
                                ...
                                <Text>
                                    Contact me on either telegram or by email with your token information to have it added!
                                </Text>
                            </Grid>
                            <Grid>
                                <Grid.Container>
                                    <Grid css={{ pr: 10 }}>
                                        <Link href="mailto://butiyam@gmail.com" target="_blank">
                                    ...
                                    <Grid>
                                        <Link href="https://t.me/butiyam" target="_blank">
                                            <Button auto size="lg" rounded> 
                                                Telegram
                                            </Button>
                                        </Link>
